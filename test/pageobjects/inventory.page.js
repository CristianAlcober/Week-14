class InventoryPage {
    ...
    get productFilter() { return $('.right_component') }
    get robotPeeking() { return $('.peek') }
    ...
    get btnsAddToCart() { return $('.btn_primary') }
    ...
    get productOneImage() { return $('#item_4_img_link') }
    get productTwoImage() { return $('#item_0_img_link') }
    get productThreeImage() { return $('#item_1_img_link') }
    get productFourImage() { return $('#item_5_img_link') }
    get productFiveImage() { return $('#item_2_img_link') }
    get productSixImage() { return $('#item_3_img_link') }
    get productsImages() { return $('.inventory_item_img') }
